...
const { createBucket,checkBucketExists, getS3Object, putS3Object } = require("./Classes/S3");
...
app.use(cors());
// app.use(express.static("../432client/build"));
...
app.get("/init", async (req, res) => {
  try{
    ...
    if(!bucket) {await createBucket(bucketName,s3Client)}
